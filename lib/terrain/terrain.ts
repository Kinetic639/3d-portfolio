...
export const TERRAIN_INSTANCE_COUNT = WORLD_FOUNDATION_CELL_COUNT;
export const CHUNK_INSTANCE_COUNT = CHUNK_SURFACE_CELL_COUNT * WORLD_FOUNDATION_LEVEL_COUNT;
